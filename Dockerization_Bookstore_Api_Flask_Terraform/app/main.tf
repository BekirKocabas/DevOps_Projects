...
provider "github" {
  token = "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"
}
provider "aws" {
  region = "us-east-1"
}
...
resource "github_repository_file" "app-files" {
  ...
  overwrite_on_create = true #daha sonra dosyanizda degisiklik yapmaniza izi veriyor  
}
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
            ...
            FOLDER="https://$TOKEN@raw.githubusercontent.com/<your github user name>/bookstore-api/main/"
            ...
            docker build -t <your docker hub user name>/bookstoreapi:latest .
            docker-compose up -d
            EOF
